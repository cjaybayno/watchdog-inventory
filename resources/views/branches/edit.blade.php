...
@section('content')
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1 class="pull-left">Branch Edit</h1>
					...
					<form class="form-horizontal">
						...
						<div class="col-sm-5">
							<div class="form-group" id="form-group-code">
							  ...
							  <div class="col-sm-8">
								...
								<input type="text" name="code" style="width:50%; text-transform:uppercase;" class="form-control" id="code" value="{{ $branch->code }}" >
							  </div>
							</div>
							<div class="form-group" id="form-group-name">
							  ...
							  <div class="col-sm-8">
								...
								<input type="text" name="name" style="text-transform:capitalize;" class="form-control" id="name" value="{{ $branch->name }}">
							  </div>
							</div>
							<br>
							<div class="form-group" id="form-group-contact_person">
							  ...
							  <div class="col-sm-8">
								...
								<input type="text" name="contact_person" style="text-transform:capitalize;" class="form-control" id="contact_person" value="{{ $branch->contact_person }}">
							  </div>
							</div>
							<div class="form-group" id="form-group-contact_number">
							  ...
							  <div class="col-sm-8">
								...
								<input type="text" name="contact_number" class="form-control" id="contact_number" value="{{ $branch->contact_number }}">
							  </div>
							</div>
							<div class="form-group" id="form-group-fax_number">
							  ...
							  <div class="col-sm-8">
								...
								<input type="text" name="fax_number" class="form-control" id="fax_number" value="{{ $branch->fax_number }}">
							  </div>
							</div>
						...
						<div class="col-sm-6">
							<div class="form-group" id="form-group-address">
							  ...
							  <div class="col-sm-8" data-toggle="modal" data-target="#address-modal" id="address-modal-toggle">
								...
								<textarea class="form-control" id="address" rows="5">{{ $branch->street.'&#13;&#10;'.$branch->brgy_town.'&#13;&#10;'.$branch->province_city.'&#13;&#10;'.$branch->zipcode.'&#13;&#10;'.$branch->country }}</textarea>
							  </div>
							</div>
							<br>
							<div class="form-group" id="form-group-remarks">
							  ...
							  <div class="col-sm-8">
								...
								<textarea class="form-control" id="remarks" rows="5">{{ $branch->remarks }}</textarea>
							  </div>
							</div>
						</div>
					  </div><!-- /.box-body -->
					  <div class="box-footer">
						<div class="col-sm-offset-1 col-sm-4">
						  ...
						  <button type="submit" class="btn btn-info btn-sm" id="edit-btn" style="display:none;">Edit</button>
						  &nbsp
		...
		<div class="col-xs-12">
			<div class="form-group" id="form-group-street">
			  <label for="street" class="control-label">Street</label>
				<input type="text" name="street" class="form-control" id="street" value="{{ $branch->street }}">
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group" id="form-group-province_city">
			  <label for="province_city" class="control-label">Province/City</label>
				{!! Form::select('province_city', $selectProvinceCity, $branch->province_city, ['class' => 'form-control select2', 'id' => 'province_city', 'style' => 'width:100%']) !!}
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group" id="form-group-brgy_town">
			  <label for="brgy_town" class="control-label">Barangay/Town</label>
				{!! Form::select('brgy_town', $selectBrgyTown, $branch->brgy_town, ['class' => 'form-control select2', 'id' => 'brgy_town', 'style' => 'width:100%']) !!}
			</div>
		</div>
		<div class="col-sm-6">
		...
		<div class="col-sm-6">
			<div class="form-group">
			  <label for="zipcode" class="control-label">Zipcode</label>
				<input type="text" name="zipcode" class="form-control" id="zipcode"  value="{{ $branch->zipcode }}" readonly>
			</div>
		</div>
	 </div>
