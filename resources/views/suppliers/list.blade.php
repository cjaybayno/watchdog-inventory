...
@section('addScripts')
	...
	<script src="{!! asset('resources/assets/js/supplier/supplier-function.js') !!}"></script>
@endsection
		  ...
		  <div class="pull-right">
			<div class="btn-group">
			  <a href="{{ URL::route('suppliers.create') }}">
				<button class="btn btn-block btn-sm btn-primary"><span class="fa fa-plus-circle"></span> Create Supplier</button>
			</a>
			</div>
		  </div>
        </section>
            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-body">
				    ...
				    @endif
				  <table id="suppliers-list-table"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					<thead>
					  <tr>
						<th>Code</th>
						<th>Supplier Name</th>
