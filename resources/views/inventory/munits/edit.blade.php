			  ...
			  <div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header">
					  <h4>Edit Measurements Units</h4>
					</div>
					<form class="form-horizontal" method="POST" action="{{ URL::route('munits.update', $munits->id) }}">
					  {!! csrf_field() !!}
					  <div class="box-body">
						...
						<div class="form-group {{ ! empty($errors->first('name')) ? 'has-error' : '' }}">
						  ...
						  <div class="col-sm-5">
							...
							@endif
							<input type="text" name="name" class="form-control" id="inputName3" placeholder="Name" value="{{ $munits->name }}">
						  </div>
						</div>
						...
						<div class="form-group {{ ! empty($errors->first('symbol')) ? 'has-error' : '' }}">
						  ...
						  <div class="col-sm-5">
							...
							@endif
							<input type="text" name="symbol" class="form-control" id="inputSymbol3" placeholder="Symbol" value="{{ $munits->symbol }}">
						  </div>
						</div>
						...
						<div class="form-group {{ ! empty($errors->first('category')) ? 'has-error' : '' }}">
						  ...
						  <div class="col-sm-5">
							...
							@endif
							<input type="text" name="category" class="form-control" id="inputCategory3" placeholder="Category" value="{{ $munits->category }}">
						  </div>
						</div>
