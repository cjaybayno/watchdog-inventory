...
@section('title', 'Items Unit Of Measurement')
...
@section('addScripts')
	...
	<script>
		var route = 'items-uom'
		var dataTableSelector = $('#items-uom-list-table');
	</script>
@endsection
...
@section('content')
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1 class="pull-left">
            Items Unit Of Measurement List
          </h1>
		  <div class="pull-right">
			<div class="btn-group">
				<div data-toggle="modal" data-target="#create-form-modal">
					<button class="btn btn-block btn-sm btn-primary"><span class="fa fa-plus-circle"></span> Create Unit Of Measurement</button>
				</div>
			</div>
		  </div>
        </section>
            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-body">
				    ...
				    @endif
				  <table id="items-uom-list-table"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					<thead>
					  <tr>
						<th>Name</th>
						<th>Label</th>
