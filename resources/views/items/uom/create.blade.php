  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  <div class="modal-header">
		<h4 class="modal-title">Create Unit Of Measurement</h4>
	  </div>
	  <div class="modal-body col-sm-12">
		...
		<div class="col-xs-12">
			<div class="form-group" id="form-group-name">
				...
				<input type="text" name="name" style="text-transform:capitalize;" class="form-control" id="name" placeholder="UOM Name">
			</div>
		</div>
		<div class="col-xs-12">
			<div class="form-group" id="form-group-label">
				...
				<input type="text" name="label" class="form-control" id="label" placeholder="UOM Label">
			</div>
		</div>
		<div class="col-xs-12">
