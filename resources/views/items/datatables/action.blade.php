  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  ...
	  <div class="modal-footer">
		...
		<button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="delete-item-close-after-{{ $id }}" onclick="clickCloseBtnAfterDeleteHandler('items')" style="display:none">Close</button>
		<button type="button" class="btn btn-danger" id="delete-item-confirm-{{ $id }}" onclick="clickConfirmBtnDeleteBtnHandler({{ $id }}, 'item', 'items')">Confirm</button>
	  </div>
	</div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->